...
public class KierowcyManager {
    ...
    public void fillDB(){
//        save(new KierowcaEntity((long) 1, "Stefan", "Pierwszy", "88121467678","500600100","Warszawa","Kiermaszowa", "89/2","2011-01-02","spierwszy@praca.pl","kierowca","94922700046623930487800469", RoleName.KIEROWCA, )));
    }
}
